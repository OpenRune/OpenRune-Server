...
internal object TreeLocs : LocReferences() {
    val achey_tree = loc("achey_tree")
    val arctic_pine = loc("arctic_pine")
    val fossil_deadtree_large1 = loc("fossil_deadtree_large1")
    val fossil_deadtree_small1 = loc("fossil_deadtree_small1")
    val deadtree1 = loc("deadtree1")
    val deadtree1_large = loc("deadtree1_large")
    val deadtree4 = loc("deadtree4")
    val lightdeadtree1 = loc("lightdeadtree1")
    val deadtree2 = loc("deadtree2")
    val deadtree2_dark = loc("deadtree2_dark")
    val deadtree3 = loc("deadtree3")
    val deadtree2_snowy = loc("deadtree2_snowy")
    val deadtree2_swamp = loc("deadtree2_swamp")
    val deadtree6 = loc("deadtree6")
    val deadtree_burnt = loc("deadtree_burnt")
    val mdaughter_passable_tree = loc("mdaughter_passable_tree")
    val fai_varrock_dead_tree = loc("fai_varrock_dead_tree")
    val evergreen_vsnowy_large = loc("evergreen_vsnowy_large")
    val evergreen_snowy_large = loc("evergreen_snowy_large")
    val evergreen = loc("evergreen")
    val evergreen_large = loc("evergreen_large")
    val hollow_tree = loc("hollow_tree")
    val hollow_tree_big = loc("hollow_tree_big")
    val mm_bush_kharazi_jungle_tree1 = loc("mm_bush_kharazi_jungle_tree1")
    val mm_bush_kharazi_jungle_tree2 = loc("mm_bush_kharazi_jungle_tree2")
    val magictree = loc("magictree")
    val prif_mahoganytree = loc("prif_mahoganytree")
    val mahoganytree_update = loc("mahoganytree_update")
    val mahoganytree = loc("mahoganytree")
    val mapletree = loc("mapletree")
    val prif_mapletree = loc("prif_mapletree")
    val mapletree_update = loc("mapletree_update")
    val mature_juniper_tree = loc("mature_juniper_tree")
    val oaktree = loc("oaktree")
    val tree_oak_default01 = loc("tree_oak_default01")
    val redwoodtree_l = loc("redwoodtree_l")
    val redwoodtree_r = loc("redwoodtree_r")
    val tree = loc("tree")
    val lighttree = loc("lighttree")
    val tree2 = loc("tree2")
    val tree3 = loc("tree3")
    val lighttree2 = loc("lighttree2")
    val snowtree1 = loc("snowtree1")
    val snowtree2 = loc("snowtree2")
    val snowtree3 = loc("snowtree3")
    val pest_tree = loc("pest_tree")
    val pest_tree2 = loc("pest_tree2")
    val prif_tree_normal_1 = loc("prif_tree_normal_1")
    val prif_tree_normal_2 = loc("prif_tree_normal_2")
    val prif_outside_tree_normal_1 = loc("prif_outside_tree_normal_1")
    val prif_outside_tree_normal_2 = loc("prif_outside_tree_normal_2")
    val regicide_tree_large = loc("regicide_tree_large")
    val regicide_tree_large2 = loc("regicide_tree_large2")
    val regicide_tree_large3 = loc("regicide_tree_large3")
    val regicide_tree_small = loc("regicide_tree_small")
    val tree_update_1 = loc("tree_update_1")
    val tree_update_2 = loc("tree_update_2")
    val tree_normal_default01 = loc("tree_normal_default01")
    val avium_tree_1 = loc("avium_tree_1")
    val avium_tree_2 = loc("avium_tree_2")
    val tree4 = loc("tree4")
    val avium_tree_dark = loc("avium_tree_dark")
    val prif_teaktree = loc("prif_teaktree")
    val teaktree_update = loc("teaktree_update")
    val teaktree = loc("teaktree")
    val willowtree = loc("willowtree")
    val willow_tree2 = loc("willow_tree2")
    val willow_tree3 = loc("willow_tree3")
    val willow_tree4 = loc("willow_tree4")
    val yewtree = loc("yewtree")
    val prif_yewtree = loc("prif_yewtree")
    val yewtree_update = loc("yewtree_update")
    val tree_yew_default01 = loc("tree_yew_default01")
    val deadman_yewtree_insurancestall = loc("deadman_yewtree_insurancestall")
}

internal object StumpLocs : LocReferences() {
    val arctic_pine_stump_21274 = loc("arctic_pine_tree_stump")
    val achey_stump_3371 = loc("achey_tree_stump")
    val burnt_stump_30855 = loc("fossil_deadtree_large1_stump")
    val burnt_stump_30856 = loc("fossil_deadtree_small1_stump")
    val dead_stump_1347 = loc("deadtree1_large_stump")
    val dead_stump_1349 = loc("deadtree1_light_stump")
    val dead_stump_1351 = loc("deadtree2_stump")
    val dead_stump_1352 = loc("deadtree2_stump_swamp")
    val dead_stump_1353 = loc("deadtree2_stump_dark")
    val dead_stump_1354 = loc("deadtree3_stump")
    val dead_stump_1358 = loc("deadtree6_stump")
    val dead_stump_23054 = loc("deadtree2_stump_snow")
    val dead_stump_5905 = loc("mdaughter_passable_tree_stump")
    val dead_stump_6212 = loc("deadtree4_stump")
    val dying_stump_3649 = loc("fai_varrock_dead_tree_stump")
    val evergreen_stump_1355 = loc("evergreen_large_stump")
    val hollow_stump_2310 = loc("hollow_tree_stump")
    val hollow_stump_4061 = loc("hollow_tree_stump_big")
    val jungle_stump_4819 = loc("mm_bush_kharazi_jungle_tree1_stump")
    val jungle_stump_4821 = loc("mm_bush_kharazi_jungle_tree2_stump")
    val magic_stump_9713 = loc("magic_tree_stump_new")
    val mahogany_stump_36689 = loc("prif_mahogany_stump")
    val mahogany_stump_40761 = loc("mahoganytree_update_stump")
    val mahogany_stump_9035 = loc("mahogany_stump")
    val maple_stump_36682 = loc("prif_mapletree_stump")
    val maple_stump_40755 = loc("mapletree_update_stump")
    val maple_stump_9712 = loc("maple_tree_stump_new")
    val mature_stump_27500 = loc("mature_juniper_tree_stump")
    val oak_stump_1356 = loc("oaktree_stump")
    val oak_stump_42396 = loc("tree_oak_stump01")
    val redwood_stump_29669 = loc("redwoodtree_l_cut")
    val redwood_stump_29671 = loc("redwoodtree_r_cut")
    val regular_stump_1342 = loc("treestump2")
    val regular_stump_1343 = loc("treestump2_light")
    val regular_stump_36673 = loc("prif_tree_normal_1_stump")
    val regular_stump_36675 = loc("prif_tree_normal_2_stump")
    val regular_stump_36678 = loc("prif_outside_tree_normal_1_stump")
    val regular_stump_3880 = loc("regicide_tree_stump")
    val regular_stump_3884 = loc("regicide_tree_stump_small")
    val regular_stump_40751 = loc("tree_update_1_stump")
    val regular_stump_40753 = loc("tree_update_2_stump")
    val regular_stump_42394 = loc("tree_normal_stump01")
    val regular_stump_51763 = loc("avium_tree_1_stump")
    val regular_stump_51765 = loc("avium_tree_2_stump")
    val regular_stump_53189 = loc("avium_tree_dark_stump")
    val teak_stump_36687 = loc("prif_teak_stump")
    val teak_stump_40759 = loc("teaktree_update_stump")
    val teak_stump_9037 = loc("teak_stump")
    val willow_stump_9471 = loc("willow_tree2or3or4_stump")
    val willow_stump_9711 = loc("willow_tree_stump_new")
    val yew_stump_36684 = loc("prif_yewtree_stump")
    val yew_stump_40757 = loc("yewtree_update_stump")
    val yew_stump_42392 = loc("tree_yew_stump01")
    val yew_stump_9714 = loc("yew_tree_stump_new")
}
