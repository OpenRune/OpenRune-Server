...
private fun obstacle(
    ...
    ticks: Int = 2,
    slide: Boolean = false,
) = Obstacle(listOf(loc), landing, xp, anim, ticks, slide)
...
object AgilityCourses {
    ...
    // Lap bonuses are the wiki values; per-obstacle xp came from a 184 reference server.
            ...
            Course(
                ...
                obstacles =
                    listOf(
                        ...
                        obstacle("loc.obstical_net2", Landing(z = 3424, level = 1), 7.5, CLIMB),
                        obstacle("loc.climbing_branch", at(2473, 3420, 2), 5.0, CLIMB),
                        obstacle(
                            "loc.balancing_rope",
                            at(2483, 3420, 2),
                            7.5,
                        ...
                        obstacle("loc.climbing_tree", at(2485, 3419, 0), 5.0, CLIMB),
                        obstacle("loc.obstical_net3", Landing(z = 3428, level = 0), 4.0, CLIMB),
                        Obstacle(
            ...
            Course(
                ...
                obstacles =
                    listOf(
                        ...
                        obstacle("loc.rooftops_falador_gap_3", Landing(dz = -4), 25.0, HURDLE),
                        obstacle("loc.rooftops_falador_ledge_1", Landing(dx = -2), 10.0, HURDLE),
                        obstacle("loc.rooftops_falador_ledge_2", Landing(dz = -2), 10.0, HURDLE),
                        obstacle("loc.rooftops_falador_ledge_3a", Landing(dz = -2), 10.0, HURDLE),
                        obstacle("loc.rooftops_falador_ledge_4", Landing(dx = 2), 10.0, HURDLE),
                        obstacle(
