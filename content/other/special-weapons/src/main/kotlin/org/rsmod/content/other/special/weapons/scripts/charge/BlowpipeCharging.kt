 ...
 *
 * "Use scales on blowpipe" used to silently do nothing - see `FinishedPotionsEvents.heldUExclude`
 * for why (a Herblore catch-all was intercepting scales before dispatch reached this file).
 */
