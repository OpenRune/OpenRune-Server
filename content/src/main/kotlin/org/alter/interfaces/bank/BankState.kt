...
object BankState {
    ...
    var Player.bankQuantityType by intVarBit("varbits.bank_requestedquantity")
    var Player.bankPlaceholderMode by boolVarBit("varbits.bank_leaveplaceholders")
    var Player.bankCurrentTab by intVarBit("varbits.bank_currenttab")

    var Player.bankTab0Size by intVarBit("varbits.bank_tab_display")
    var Player.bankTab1Size by intVarBit("varbits.bank_tab_1")
    var Player.bankTab2Size by intVarBit("varbits.bank_tab_2")
    var Player.bankTab3Size by intVarBit("varbits.bank_tab_3")
    var Player.bankTab4Size by intVarBit("varbits.bank_tab_4")
    var Player.bankTab5Size by intVarBit("varbits.bank_tab_5")
    var Player.bankTab6Size by intVarBit("varbits.bank_tab_6")
    var Player.bankTab7Size by intVarBit("varbits.bank_tab_7")
    var Player.bankTab8Size by intVarBit("varbits.bank_tab_8")
    var Player.bankTab9Size by intVarBit("varbits.bank_tab_9")
