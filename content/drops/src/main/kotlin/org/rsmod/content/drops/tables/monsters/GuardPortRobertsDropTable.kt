...
@JvmField
public val guardPortRobertsDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guard (Port Roberts) Drops",
    npcs = npcs("npc.port_roberts_guard_f1", "npc.port_roberts_guard_f2", "npc.port_roberts_guard_m1", "npc.port_roberts_guard_m2"),
