...
@JvmField
public val eliteDarkMageDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Elite Dark Mage Drops",
    npcs = npcs("npc.elite_dark_mage_1", "npc.elite_dark_mage_2"),
    mainTable = rsPlayerWeightedTable(total = 117) {
        name("Elite Dark Mage Drops")
