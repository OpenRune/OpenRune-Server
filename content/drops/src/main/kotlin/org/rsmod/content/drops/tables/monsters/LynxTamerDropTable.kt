...
@JvmField
public val lynxTamerDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Lynx Tamer Drops",
    npcs = npcs("npc.shayzien_lynx_tamer"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Lynx Tamer Drops")
