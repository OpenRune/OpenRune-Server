...
@JvmField
public val guardTlatiRainforestDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guard (Tlati Rainforest) Drops",
    npcs = npcs("npc.tlati_guard_f_1", "npc.tlati_guard_f_2", "npc.tlati_guard_f_3", "npc.tlati_guard_f_4", "npc.tlati_guard_m_1", "npc.tlati_guard_m_2", "npc.tlati_guard_m_3", "npc.tlati_guard_m_4"),
