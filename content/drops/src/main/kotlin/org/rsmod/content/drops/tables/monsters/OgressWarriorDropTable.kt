...
@JvmField
public val ogressWarriorDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Ogress Warrior Drops",
    npcs = npcs("npc.ogress_warrior1", "npc.ogress_warrior2"),
    mainTable = rsPlayerWeightedTable(total = 116) {
        name("Ogress Warrior Drops")
