...
@JvmField
public val trollSpectatorDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Troll spectator Drops",
    npcs = npcs("npc.troll_spectator1", "npc.troll_spectator2", "npc.troll_spectator3", "npc.troll_spectator4", "npc.troll_spectator5", "npc.troll_spectator6", "npc.troll_spectator7"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Troll spectator Drops")
