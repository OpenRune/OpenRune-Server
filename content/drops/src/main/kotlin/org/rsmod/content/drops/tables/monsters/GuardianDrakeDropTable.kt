...
@JvmField
public val guardianDrakeDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guardian Drake Drops",
    npcs = npcs("npc.superior_drake"),
