...
@JvmField
public val sirCarlDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Sir Carl Drops",
    npcs = npcs("npc.upass_paladin2_vis"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.paladinbadge2" count 1 condition {
