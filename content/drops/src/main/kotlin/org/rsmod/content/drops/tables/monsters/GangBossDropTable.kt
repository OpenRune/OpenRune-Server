...
@JvmField
public val gangBossDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Gang boss Drops",
    npcs = npcs("npc.shayzien_criminal_boss_1_chatting", "npc.shayzien_criminal_boss_1_fighting", "npc.shayzien_criminal_boss_2_chatting", "npc.shayzien_criminal_boss_2_fighting"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.shayzien_gang_intelligence" count 1
    },
    preRoll = rsPlayerPrerollTable {
        1 outOf 80 weight "obj.rune_scimitar" count 1
    },
    mainTable = rsPlayerWeightedTable(total = 256) {
        name("Gang boss Drops")
        ...
        25 weight "obj.cert_bucket_compost" count 45..80
