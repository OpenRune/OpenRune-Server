...
@JvmField
public val warpedTortoiseDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Warped Tortoise Drops",
    npcs = npcs("npc.pog_mutated_tortoise"),
    mainTable = rsPlayerWeightedTable(total = 64) {
        name("Warped Tortoise Drops")
