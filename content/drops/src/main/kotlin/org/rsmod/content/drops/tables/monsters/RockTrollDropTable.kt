...
@JvmField
public val rockTrollDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Rock (Troll) Drops",
    npcs = npcs("npc.death_troll_commander"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Rock (Troll) Drops")
