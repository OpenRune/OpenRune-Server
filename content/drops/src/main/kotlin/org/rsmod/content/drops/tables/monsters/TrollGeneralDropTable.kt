...
@JvmField
public val trollGeneralDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Troll general Drops",
    npcs = npcs("npc.troll_general", "npc.troll_general2", "npc.troll_general3"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.troll_key_prison" count 1 condition {
            player -> player.isOnQuest("quest_trollstrongholdquest")
        }
    },
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Troll general Drops")
