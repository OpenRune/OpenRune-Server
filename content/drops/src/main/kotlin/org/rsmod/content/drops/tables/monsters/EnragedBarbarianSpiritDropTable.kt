...
@JvmField
public val enragedBarbarianSpiritDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Enraged barbarian spirit Drops",
    npcs = npcs("npc.brut_angry_spirit2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Enraged barbarian spirit Drops")
