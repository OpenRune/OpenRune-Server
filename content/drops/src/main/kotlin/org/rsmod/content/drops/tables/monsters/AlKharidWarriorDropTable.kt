...
@JvmField
public val alKharidWarriorDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Al Kharid warrior Drops",
    npcs = npcs("npc.al_kharid_warrior"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Al Kharid warrior Drops")
