...
@JvmField
public val donnyTheLadDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Donny the lad Drops",
    npcs = npcs("npc.donny_the_lad"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Donny the lad Drops")
