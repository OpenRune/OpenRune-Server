...
@JvmField
public val screamingTwistedBansheeDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Screaming twisted banshee Drops",
    npcs = npcs("npc.superior_kourend_banshee"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Screaming twisted banshee Drops")
