...
@JvmField
public val goblinVaultOfWarDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Goblin (Vault of War) Drops",
    npcs = npcs("npc.sos_war_goblin_armed", "npc.sos_war_goblin_armed2", "npc.sos_war_goblin_green_soldier_1", "npc.sos_war_goblin_green_soldier_2", "npc.sos_war_goblin_helmet", "npc.sos_war_goblin_helmet2"),
