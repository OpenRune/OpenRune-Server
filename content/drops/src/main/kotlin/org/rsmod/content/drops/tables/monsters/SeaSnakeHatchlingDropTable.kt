...
@JvmField
public val seaSnakeHatchlingDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Sea Snake Hatchling Drops",
    npcs = npcs("npc.royal_sea_snake_baby"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Sea Snake Hatchling Drops")
        2 weight "obj.waterrune" count 15
        2 weight "obj.mistrune" count 1
        2 weight "obj.slayer_broad_arrows" count 4
        60 weight "obj.coins" count 44
