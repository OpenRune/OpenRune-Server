...
@JvmField
public val angryBarbarianSpiritDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Angry barbarian spirit Drops",
    npcs = npcs("npc.brut_angry_spirit1"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Angry barbarian spirit Drops")
