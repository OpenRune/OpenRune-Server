...
@JvmField
public val towerGuardDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Tower guard Drops",
    npcs = npcs("npc.tower_guard"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Tower guard Drops")
