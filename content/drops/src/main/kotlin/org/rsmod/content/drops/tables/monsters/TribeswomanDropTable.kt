...
@JvmField
public val tribeswomanDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Tribeswoman Drops",
    npcs = npcs("npc.tribeswoman", "npc.tribeswoman_variant01"),
    mainTable = rsPlayerWeightedTable(total = 138) {
        name("Tribeswoman Drops")
