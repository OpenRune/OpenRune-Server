...
@JvmField
public val waterElementalDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Water elemental Drops",
    npcs = npcs("npc.elemental_water"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.vial_water" count 1
    },
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Water elemental Drops")
        13 weight "obj.waterrune" count 15
        ...
        2 weight "obj.staff_of_water" count 1
