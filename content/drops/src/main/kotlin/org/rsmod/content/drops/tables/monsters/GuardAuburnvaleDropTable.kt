...
@JvmField
public val guardAuburnvaleDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guard (Auburnvale) Drops",
    npcs = npcs("npc.auburnvale_guard_f_1", "npc.auburnvale_guard_f_2", "npc.auburnvale_guard_f_3", "npc.auburnvale_guard_f_4", "npc.auburnvale_guard_m_1", "npc.auburnvale_guard_m_2", "npc.auburnvale_guard_m_3", "npc.auburnvale_guard_m_4"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Guard (Auburnvale) Drops")
