...
@JvmField
public val imreDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Imre Drops",
    npcs = npcs("npc.canafis_man2"),
    mainTable = rsPlayerWeightedTable(total = 512) {
        ...
        25 weight "obj.bucket_empty" count 1
