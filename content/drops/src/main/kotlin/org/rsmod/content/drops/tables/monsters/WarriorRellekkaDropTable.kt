...
@JvmField
public val warriorRellekkaDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Warrior (Rellekka) Drops",
    npcs = npcs("npc.viking_guard2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Warrior (Rellekka) Drops")
