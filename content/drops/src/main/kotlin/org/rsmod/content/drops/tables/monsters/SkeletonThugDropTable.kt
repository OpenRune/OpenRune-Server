...
@JvmField
public val skeletonThugDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Skeleton thug Drops",
    npcs = npcs("npc.brut_skeleton6"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Skeleton thug Drops")
