...
@JvmField
public val emissaryChosenDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Emissary Chosen Drops",
    npcs = npcs("npc.twilight_cultist_chosen_f_1", "npc.twilight_cultist_chosen_f_2", "npc.twilight_cultist_chosen_f_3", "npc.twilight_cultist_chosen_m_1", "npc.twilight_cultist_chosen_m_2", "npc.twilight_cultist_chosen_m_3"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Emissary Chosen Drops")
