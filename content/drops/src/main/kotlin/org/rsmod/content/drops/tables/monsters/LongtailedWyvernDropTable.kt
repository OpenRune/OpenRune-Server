...
@JvmField
public val longtailedWyvernDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Long-tailed Wyvern Drops",
    npcs = npcs("npc.wyvern_long_tailed"),
    mainTable = rsPlayerWeightedTable(total = 123) {
        name("Long-tailed Wyvern Drops")
