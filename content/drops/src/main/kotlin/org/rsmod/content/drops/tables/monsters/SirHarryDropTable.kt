...
@JvmField
public val sirHarryDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Sir Harry Drops",
    npcs = npcs("npc.upass_paladin3_vis"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.paladinbadge3" count 1 condition {
            player -> player.isOnQuest("quest_undergroundpassquest")
        }
    },
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Sir Harry Drops")
