...
@JvmField
public val berserkBarbarianSpiritDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Berserk barbarian spirit Drops",
    npcs = npcs("npc.brut_angry_spirit3"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Berserk barbarian spirit Drops")
