...
@JvmField
public val elfArcherDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Elf Archer Drops",
    npcs = npcs("npc.mourning_guard_range", "npc.mourning_guard_range2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Elf Archer Drops")
