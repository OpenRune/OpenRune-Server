...
@JvmField
public val spittingWyvernDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Spitting Wyvern Drops",
    npcs = npcs("npc.wyvern_spitting"),
    mainTable = rsPlayerWeightedTable(total = 123) {
        name("Spitting Wyvern Drops")
