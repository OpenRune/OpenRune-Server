...
@JvmField
public val cockatriceDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Cockatrice Drops",
    npcs = npcs("npc.slayer_cockatrice"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Cockatrice Drops")
