...
@JvmField
public val vitreousWarpedJellyDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Vitreous Warped Jelly Drops",
    npcs = npcs("npc.superior_kourend_jelly"),
    ...
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Vitreous Warped Jelly Drops")
