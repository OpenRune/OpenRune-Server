...
@JvmField
public val ancientCustodianDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Ancient Custodian Drops",
    npcs = npcs("npc.superior_custodian"),
    mainTable = rsPlayerWeightedTable(total = 124) {
        name("Ancient Custodian Drops")
