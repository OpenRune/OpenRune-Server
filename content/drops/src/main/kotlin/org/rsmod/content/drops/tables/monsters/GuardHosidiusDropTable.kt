...
@JvmField
public val guardHosidiusDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guard (Hosidius) Drops",
    npcs = npcs("npc.hos_town_guard_01", "npc.hos_town_guard_02", "npc.hos_town_guard_03", "npc.hos_town_guard_04"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Guard (Hosidius) Drops")
