...
@JvmField
public val desertLizardDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Desert Lizard Drops",
    npcs = npcs("npc.slayer_lizard_large1_green", "npc.slayer_lizard_large1_green_lowrange", "npc.slayer_lizard_large2_sandy", "npc.slayer_lizard_large3_sandy"),
    mainTable = rsPlayerWeightedTable(total = 147) {
        name("Desert Lizard Drops")
