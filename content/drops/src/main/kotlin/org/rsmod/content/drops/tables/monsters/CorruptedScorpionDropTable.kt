...
@JvmField
public val corruptedScorpionDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Corrupted Scorpion Drops",
    npcs = npcs("npc.crystal_scorpion_hm"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.gauntlet_crystal_shard_hm" count 50..100
    },
    mainTable = rsPlayerWeightedTable(total = 21) {
    ...
    tertiaries = rsPlayerTertiaryTable {
        2 outOf 7 weight "obj.gauntlet_generic_component_hm" count 1 condition { player ->
            // Drops Need Manual: Guaranteed after killing two of the mid-level monsters ([[Corrupted Unicorn
             true
        }
    },
)
