...
@JvmField
public val twigDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Twig Drops",
    npcs = npcs("npc.troll_prison_guard1", "npc.troll_prison_guard1_awake"),
