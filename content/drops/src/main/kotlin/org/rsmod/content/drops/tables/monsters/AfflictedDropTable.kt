...
@JvmField
public val afflictedDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Afflicted Drops",
    npcs = npcs("npc.mort_afflicted_man", "npc.mort_afflicted_man2", "npc.mort_afflicted_woman", "npc.mort_afflicted_woman2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Afflicted Drops")
