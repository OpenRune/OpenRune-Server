...
@JvmField
public val seaSnakeYoungDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Sea Snake Young Drops",
    npcs = npcs("npc.royal_sea_snake_medium"),
    mainTable = rsPlayerWeightedTable(total = 133) {
        name("Sea Snake Young Drops")
