...
@JvmField
public val corruptedDragonDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Corrupted Dragon Drops",
    npcs = npcs("npc.crystal_dragon_hm"),
