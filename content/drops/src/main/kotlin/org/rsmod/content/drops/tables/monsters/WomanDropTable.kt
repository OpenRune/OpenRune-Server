...
@JvmField
public val womanDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Woman Drops",
    npcs = npcs("npc.shayzien_woman_1", "npc.shayzien_woman_2", "npc.varrock_woman1", "npc.woman", "npc.woman2", "npc.woman3", "npc.woman4", "npc.zeah_woman", "npc.zeah_woman2", "npc.zeah_woman3", "npc.zeah_woman_outside"),
