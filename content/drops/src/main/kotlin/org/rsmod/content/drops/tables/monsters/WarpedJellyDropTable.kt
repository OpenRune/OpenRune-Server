...
@JvmField
public val warpedJellyDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Warped Jelly Drops",
    npcs = npcs("npc.kourend_jelly"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Warped Jelly Drops")
