...
@JvmField
public val zombieSwabDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Zombie swab Drops",
    npcs = npcs("npc.deal_pirate_a", "npc.deal_pirate_b", "npc.deal_pirate_c", "npc.deal_pirate_d", "npc.deal_pirate_e", "npc.deal_pirate_f"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Zombie swab Drops")
