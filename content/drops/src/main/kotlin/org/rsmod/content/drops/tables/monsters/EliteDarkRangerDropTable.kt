...
@JvmField
public val eliteDarkRangerDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Elite Dark Ranger Drops",
    npcs = npcs("npc.elite_dark_ranger_1", "npc.elite_dark_ranger_2"),
    mainTable = rsPlayerWeightedTable(total = 117) {
        name("Elite Dark Ranger Drops")
