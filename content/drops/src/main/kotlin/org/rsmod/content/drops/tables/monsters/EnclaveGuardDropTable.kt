...
@JvmField
public val enclaveGuardDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Enclave guard Drops",
    npcs = npcs("npc.enclave_guard"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Enclave guard Drops")
