...
@JvmField
public val berryDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Berry Drops",
    npcs = npcs("npc.troll_prison_guard2", "npc.troll_prison_guard2_awake"),
