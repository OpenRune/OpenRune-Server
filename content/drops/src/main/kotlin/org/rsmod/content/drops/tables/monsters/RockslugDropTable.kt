...
@JvmField
public val rockslugDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Rockslug Drops",
    npcs = npcs("npc.slayer_rockslug", "npc.slayer_rockslug_baby", "npc.slayer_rockslug_crypt_of_tonali"),
