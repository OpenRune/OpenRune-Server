...
@JvmField
public val elfWarriorDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Elf Warrior Drops",
    npcs = npcs("npc.mourning_guard_melee", "npc.mourning_guard_melee2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Elf Warrior Drops")
        ...
        3 weight "obj.firerune" count 37
        ...
        1 weight "obj.adamantite_ore" count 1
