...
public val stingrayDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    ...
    tertiaries = rsPlayerTertiaryTable {
        ...
        // Drops Need Manual (rate): The hard clue scroll drop rate increases to 1/175 after unlocking the hard Combat Achievements rewards tier.
        1 outOf 185 weight "obj.trail_clue_hard_map001" count 1 transformObj { player ->
