...
@JvmField
public val sergeantShayzienDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Sergeant (Shayzien) Drops",
    npcs = npcs("npc.deadman_shayzien_soldier", "npc.shayzien_soldier_f1_big", "npc.shayzien_soldier_f2_big", "npc.shayzien_soldier_f3_big", "npc.shayzien_soldier_f4_big", "npc.shayzien_soldier_m1_big", "npc.shayzien_soldier_m2_big", "npc.shayzien_soldier_m3_big", "npc.shayzien_soldier_m4_big"),
    preRoll = rsPlayerPrerollTable {
        1 outOf 512 weight "obj.rune_kiteshield" count 1
        1 outOf 512 weight "obj.rune_scimitar" count 1
    },
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Sergeant (Shayzien) Drops")
