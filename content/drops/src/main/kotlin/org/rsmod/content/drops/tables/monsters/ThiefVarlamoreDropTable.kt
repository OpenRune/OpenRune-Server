...
@JvmField
public val thiefVarlamoreDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Thief (Varlamore) Drops",
    npcs = npcs("npc.varlamore_thief_f_1", "npc.varlamore_thief_f_2", "npc.varlamore_thief_f_3", "npc.varlamore_thief_m_1", "npc.varlamore_thief_m_2", "npc.varlamore_thief_m_3"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Thief (Varlamore) Drops")
        2 weight "obj.bronze_med_helm" count 1
        1 weight "obj.iron_dagger" count 1
        22 weight "obj.bolt" count 2..12
        3 weight "obj.bronze_arrow" count 5..10
        ...
        33 weight "obj.coins" count 2
        8 weight "obj.coins" count 5
        4 weight "obj.coins" count 20
        1 weight "obj.coins" count 25
        14 weight ringNothing()
        5 weight "obj.fishing_bait" count 2..4
