...
@JvmField
public val skeletonBruteDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Skeleton brute Drops",
    npcs = npcs("npc.brut_skeleton2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Skeleton brute Drops")
