...
@JvmField
public val locustRiderDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Locust rider Drops",
    npcs = npcs("npc.contact_locust_bow", "npc.contact_locust_bow_b", "npc.contact_locust_lance", "npc.contact_locust_lance_b"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Locust rider Drops")
