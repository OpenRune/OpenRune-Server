...
@JvmField
public val caveCrawlerDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Cave crawler Drops",
    npcs = npcs("npc.cave_crawler_ice_1", "npc.cave_crawler_ice_2", "npc.slayer_cave_crawler_1", "npc.slayer_cave_crawler_2", "npc.slayer_cave_crawler_3", "npc.slayer_cave_crawler_4"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Cave crawler Drops")
    ...
    tertiaries = rsPlayerTertiaryTable {
        1 outOf 1024 weight "obj.varlamore_key_half_1" count 1
    },
)

// Unknown wiki drop rates (text rarity — need data collection):
//   - Frozen tear [tertiary/<ref name=tapoyauik group=d> Only dropped by those found in the [[Ruins of Tapoyauik]].</ref>]
