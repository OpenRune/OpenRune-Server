...
@JvmField
public val colonelRadickDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Colonel Radick Drops",
    npcs = npcs("npc.colonel_radick"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Colonel Radick Drops")
