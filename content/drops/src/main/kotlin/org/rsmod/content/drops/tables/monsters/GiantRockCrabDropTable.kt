...
@JvmField
public val giantRockCrabDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Giant Rock Crab Drops",
    npcs = npcs("npc.giant_rockcrab", "npc.giant_rockcrab_crypt_of_tonali_hidden", "npc.giant_rockcrab_deeper", "npc.giant_rockcrab_hidden", "npc.giant_rockcrab_hidden_deeper"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Giant Rock Crab Drops")
