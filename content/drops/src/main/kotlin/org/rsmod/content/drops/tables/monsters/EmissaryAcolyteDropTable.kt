...
@JvmField
public val emissaryAcolyteDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Emissary Acolyte Drops",
    npcs = npcs("npc.twilight_cultist_spectator_1", "npc.twilight_cultist_spectator_1_vis", "npc.twilight_cultist_spectator_3", "npc.twilight_cultist_spectator_3_vis"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Emissary Acolyte Drops")
