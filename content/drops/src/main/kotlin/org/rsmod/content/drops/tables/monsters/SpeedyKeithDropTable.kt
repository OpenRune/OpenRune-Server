...
@JvmField
public val speedyKeithDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Speedy Keith Drops",
    npcs = npcs("npc.speedy_keith"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Speedy Keith Drops")
