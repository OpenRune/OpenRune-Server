...
@JvmField
public val shadowWyrmDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Shadow Wyrm Drops",
    npcs = npcs("npc.superior_wyrm_dark", "npc.superior_wyrm_light"),
