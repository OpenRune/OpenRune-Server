...
@JvmField
public val guardAldarinDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guard (Aldarin) Drops",
    npcs = npcs("npc.aldarin_guard_f_1", "npc.aldarin_guard_f_2", "npc.aldarin_guard_f_3", "npc.aldarin_guard_f_4", "npc.aldarin_guard_f_5", "npc.aldarin_guard_m_1", "npc.aldarin_guard_m_2", "npc.aldarin_guard_m_3", "npc.aldarin_guard_m_4", "npc.aldarin_guard_m_5"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Guard (Aldarin) Drops")
