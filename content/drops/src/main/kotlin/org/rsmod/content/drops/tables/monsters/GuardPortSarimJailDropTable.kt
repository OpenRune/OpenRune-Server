...
@JvmField
public val guardPortSarimJailDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Guard (Port Sarim jail) Drops",
    npcs = npcs("npc.jail_guard_1", "npc.jail_guard_2", "npc.jail_guard_3", "npc.jail_guard_4", "npc.jail_guard_5"),
