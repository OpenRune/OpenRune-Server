...
@JvmField
public val skeletonHeroDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Skeleton hero Drops",
    npcs = npcs("npc.brut_skeleton1"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Skeleton hero Drops")
