...
@JvmField
public val bandosianGuardDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Bandosian guard Drops",
    npcs = npcs("npc.elite_npc_2"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Bandosian guard Drops")
