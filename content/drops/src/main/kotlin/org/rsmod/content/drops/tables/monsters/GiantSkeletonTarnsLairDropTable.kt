...
@JvmField
public val giantSkeletonTarnsLairDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Giant skeleton (Tarn's Lair) Drops",
    npcs = npcs("npc.lotr_giant_skeleton"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Giant skeleton (Tarn's Lair) Drops")
