...
@JvmField
public val infernalPyrelordDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Infernal pyrelord Drops",
    npcs = npcs("npc.superior_pyrelord"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Infernal pyrelord Drops")
    ...
    tertiaries = rsPlayerTertiaryTable {
        // Drops Need Manual (rate): The medium clue scroll drop rate increases to 1/9 after unlocking the medium Combat Achievements rewards tier.
        10 outOf 104 weight "obj.trail_medium_emote_exp1" count 1 transformObj { player ->
