...
@JvmField
public val saradominPriestDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Saradomin priest Drops",
    npcs = npcs("npc.godwars_ancient_saradomin_wizard"),
