...
@JvmField
public val crushingHandDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Crushing hand Drops",
    npcs = npcs("npc.superior_crawling_hand"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Crushing hand Drops")
