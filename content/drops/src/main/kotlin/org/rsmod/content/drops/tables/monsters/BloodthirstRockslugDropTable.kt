...
@JvmField
public val bloodthirstRockslugDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Bloodthirst rockslug Drops",
    npcs = npcs("npc.league_superior_rockslug"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Bloodthirst rockslug Drops")
