...
public val phantomMuspahDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    ...
    mainTable = rsPlayerWeightedTable(total = 235) {
        ...
        1 outOf 100 separate "obj.venator_shard" count 1 condition { player ->
    ...
    tertiaries = rsPlayerTertiaryTable {
        ...
        // Drops Need Manual (rate): The hard clue scroll drop rate increases to 1/28 after unlocking the hard Combat Achievements rewards tier.
        1 outOf 30 weight "obj.trail_clue_hard_map001" count 1 transformObj { player ->
            // Drops Need Manual (item): Clue scrolls will drop as scroll boxes after the completion of X Marks the Spot.
             null
        }
        // Drops Need Manual (rate): The elite clue scroll drop rate increases to 1/42 after unlocking the elite Combat Achievements rewards tier.
        1 outOf 45 weight "obj.trail_elite_emote_exp1" count 1 transformObj { player ->
            // Drops Need Manual (item): Clue scrolls will drop as scroll boxes after the completion of X Marks the Spot.
             null
        }
    },
