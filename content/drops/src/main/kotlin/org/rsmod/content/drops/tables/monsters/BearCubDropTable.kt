...
@JvmField
public val bearCubDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Bear Cub Drops",
    npcs = npcs("npc.brownbear_cub_1", "npc.brownbear_cub_2"),
