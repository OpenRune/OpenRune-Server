...
@JvmField
public val arrgDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Arrg Drops",
    npcs = npcs("npc.trollromance_arrg", "npc.trollromance_arrg_attackable"),
