...
@JvmField
public val skeletonHeavyDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Skeleton heavy Drops",
    npcs = npcs("npc.brut_skeleton5"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Skeleton heavy Drops")
