...
@JvmField
public val crystalChestDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    ...
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Crystal Chest")
        17 weight nothing()
        34 weight rsPlayerGuaranteedTable {
            "obj.spinach_roll" count 1
            "obj.coins" count 2000
        }
        12 weight rsPlayerGuaranteedTable {
        ...
        10 weight rsPlayerGuaranteedTable {
            "obj.coins" count 750
