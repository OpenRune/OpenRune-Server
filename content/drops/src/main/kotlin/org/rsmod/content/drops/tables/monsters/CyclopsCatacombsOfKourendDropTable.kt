...
@JvmField
public val cyclopsCatacombsOfKourendDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Cyclops (Catacombs of Kourend) Drops",
    npcs = npcs("npc.kourend_cyclops1", "npc.kourend_cyclops2"),
    mainTable = rsPlayerWeightedTable(total = 100) {
        name("Cyclops (Catacombs of Kourend) Drops")
        ...
        4 weight "obj.steel_dagger" count 1
        ...
        36 weight "obj.coins" count 3..102
