...
@JvmField
public val soldierShayzienDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Soldier (Shayzien) Drops",
    npcs = npcs("npc.shayzien_soldier_f1", "npc.shayzien_soldier_f2", "npc.shayzien_soldier_f3", "npc.shayzien_soldier_f4", "npc.shayzien_soldier_m1", "npc.shayzien_soldier_m2", "npc.shayzien_soldier_m3", "npc.shayzien_soldier_m4"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Soldier (Shayzien) Drops")
        10 weight "obj.xbows_crossbow_bolts_iron" count 2..12
        4 weight "obj.steel_arrow" count 1
        3 weight "obj.bronze_arrow" count 1..2
