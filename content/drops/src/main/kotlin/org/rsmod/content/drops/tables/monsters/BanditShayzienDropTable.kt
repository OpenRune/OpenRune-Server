...
@JvmField
public val banditShayzienDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Bandit (Shayzien) Drops",
    npcs = npcs("npc.shayzien_bandit_1", "npc.shayzien_bandit_2", "npc.shayzien_bandit_3"),
    mainTable = rsPlayerWeightedTable(total = 128) {
        name("Bandit (Shayzien) Drops")
