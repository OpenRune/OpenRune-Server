...
@JvmField
public val elvenCrystalChestDropTable: RSDropTable<Player, DropRollItem> = RSDropTable(
    tableIdentifier = "Elven Crystal Chest",
    locs = locs("loc.prif_crystal_chest_closed"),
    guaranteed = rsPlayerGuaranteedTable {
        "obj.uncut_dragonstone" count 1
    },
    tertiaries = rsPlayerTertiaryTable {
        1 outOf 10000 weight "obj.uncut_onyx" count 1
        1 outOf 500 chance rsPlayerWeightedTable {
    ...
    mainTable = rsPlayerWeightedTable(total = 256) {
        ...
        20 weight rsPlayerGuaranteedTable {
        ...
        17 weight rsPlayerGuaranteedTable {
        ...
        17 weight rsPlayerWeightedTable {
