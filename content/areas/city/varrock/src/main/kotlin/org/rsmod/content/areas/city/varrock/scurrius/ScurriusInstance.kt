...
import org.rsmod.api.instance.InstanceRepository
...
class ScurriusInstance
@Inject
constructor(private val instanceRepo: InstanceRepository, private val npcRepo: NpcRepository) :
    PluginScript() {
