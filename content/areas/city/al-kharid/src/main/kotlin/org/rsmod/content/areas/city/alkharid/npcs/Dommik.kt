...
/**
 * Dommik — Dommik's Crafting Store owner (north-east Al-Kharid). M5.ALKHARID.2.
 *
 * Dialogue tracks the OSRS wiki transcript (Transcript:Dommik): Dommik offers to show his crafting
 * supplies. Trade opens the upstream `inv.craftingshop` toml inventory (F2P moulds, chisel, needle,
 * thread).
 */
class Dommik @Inject constructor(private val shops: Shops) : PluginScript() {
    ...
    private suspend fun Dialogue.shopDialogue(npc: Npc) {
        chatNpc(happy, "Welcome to my crafting store. Want to see my wares?")
    ...
    public companion object {
        public const val NPC: String = "npc.dommik"
        public const val SHOP_INV: String = "inv.craftingshop"
        public const val SHOP_TITLE: String = "Dommik's Crafting Store"
