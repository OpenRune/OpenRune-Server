...
enum class CommonClientScripts(identifier : String = "", scriptID : Int = -1) {
    ...
    BANK_CONFIRM_RELEASE(scriptID = 4212),
    COMABT_LEVEL_SUMMARY("summary_sidepanel_combat_level_transmit"),
    SET_TEXT_ALIGN("if_settextalign"),
    EXAMINE_ITEM(identifier = "examine_item"),
    HIGHLIGHT_NO_CLICK_CLEAR("highlight_noclick_clear"),
    HIGHLIGHT_START("highlight_start"),
    HIGHLIGHT_SCREEN("highlight_screen"),
    HIGHLIGHT_TEXTBOX("highlight_textbox"),
    HIGHLIGHT_SCREEN_HIDE_LAYER("highlight_screen_hide_layer"),
    ...
    MES_SLAYER_CLOSE("meslayer_close"),
    PLUGINS(scriptID = 876),
    TOOLTIP(scriptID = 1495),
