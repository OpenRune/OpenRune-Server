...
enum class Emote(
    ...
    BLOW_KISS(slot = 17, anim = 1374, gfx = "spotanims.trollromance_heart"),
    ...
    IDEA(slot = 28, anim = 4276, gfx = "spotanims.emote_lightbulb_spot", varbit = Varbit.IDEA_EMOTE_VARBIT),
    ...
    FLEX(slot = 40, anim = 8917, gfx = RSCM.NONE, varbit = Varbit.FLEX_EMOTE_VARBIT),
    ZOMBIE_HAND(slot = 41, anim = 1708, gfx = "spotanims.hw07_arm_from_the_ground_spotanim", varbit = Varbit.ZOMBIE_HAND_EMOTE_VARBIT),
    HYPERMOBILE_DRINKER(slot = 42, anim = 7131, varbit = Varbit.HYPERMOBILE_DRINKER_EMOTE_VARBIT),
    SKILLCAPE(slot = 43, anim = -1), // @TODO
    AIR_GUITAR(slot = 44, anim = 4751, gfx = "spotanims.air_guitar_spotanim", varbit = Varbit.AIR_GUITAR_EMOTE_VARBIT),
    URI_TRANSFORM(slot = 45, anim = -1, gfx = RSCM.NONE, varbit = Varbit.URI_TRANSFORM_EMOTE_VARBIT), // @TODO
    ...
    PREMIER_SHIELD(slot = 48, anim = 7751, gfx = "spotanims.premier_club_emote_spotanim_bronze", varbit = Varbit.PREMIER_SHIELD_EMOTE_VARBIT),
    ...
    RELIC_UNLOCKED(slot = 50, anim = 8524, gfx = "spotanims.league_trailblazer_relic_unlock_spot", varbit = Varbit.RELIC_UNLOCKED_EMOTE_VARBIT, requiredVarbitValue = 9), // @TODO unlockDescription = "You can't use that emote unless you have stored a tier 3 relichunter \n outfit on the outfitstand in your player owned house League Hall."
    PARTY(slot = 51, anim = 10031, gfx = "spotanims.fx_emote_party01_active", varbit = Varbit.PARTY_EMOTE_VARBIT),
    ;
