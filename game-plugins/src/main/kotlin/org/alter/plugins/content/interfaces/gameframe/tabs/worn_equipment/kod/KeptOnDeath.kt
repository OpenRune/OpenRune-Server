...
object KeptOnDeath {
    ...
    fun open(
        ...
        // p.runClientScript(972, 0, 0, 0, 0, "", if (p.getVarp("varp.desert")==1) 4 else 3, keptContainer[0]?.id ?: -1, keptContainer[1]?.id ?: -1, keptContainer[2]?.id ?: -1, if (p.getVarbit(599) == 1) keptContainer[3]!!.id else -1)
