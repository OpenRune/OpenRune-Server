...
@RsTableHeaders("walktrigger")
data class WalkTriggerType(
    override var id: Int = -1,
    var priority: WalkTriggerPriority = WalkTriggerPriority.None,
) : Definition {
    companion object {
        fun WalkTriggerType?.isType(type: WalkTriggerType): Boolean {
