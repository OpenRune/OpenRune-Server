...
class HealthBarServerCodec(val health: Map<Int, HealthBarType>? = null) :
    OpcodeDefinitionCodec<HealthBarServerType>() {

    override val definitionCodec =
        OpcodeList<HealthBarServerType>().apply {
            add(DefinitionOpcode(1, OpcodeType.BYTE, HealthBarServerType::segments))
        }
