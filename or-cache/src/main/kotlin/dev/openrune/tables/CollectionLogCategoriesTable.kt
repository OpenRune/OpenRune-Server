...
object CollectionLogCategoriesTable {
    ...
    fun collectionLogCategories() =
        dbTable("dbtable.collection_log_categories", serverOnly = true) {
            ...
            row("dbrow.collection_log_category_deranged_archaeologist") {
                ...
                columnRSCM(
                    COMPLETED_VARBIT,
                    "varbit.collection_bosses_deranged_archaeologist_completed",
                )
            ...
            row("dbrow.collection_log_category_barracuda_trials") {
                ...
                columnRSCM(
                    COMPLETED_VARBIT,
                    "varbit.collection_minigames_barracuda_trials_completed",
                )
            }
            ...
            row("dbrow.collection_log_category_hallowed_sepulchre") {
                ...
                columnRSCM(
                    COMPLETED_VARBIT,
                    "varbit.collection_minigames_hallowed_sepulchre_completed",
                )
            }
            ...
            row("dbrow.collection_log_category_mahogany_homes") {
                ...
                columnRSCM(
                    COMPLETED_VARBIT,
                    "varbit.collection_minigames_constructioncontracts_completed",
                )
            }
            ...
            row("dbrow.collection_log_category_mastering_mixology") {
                ...
                columnRSCM(
                    COMPLETED_VARBIT,
                    "varbit.collection_minigames_mastering_mixology_completed",
                )
            }
            ...
            row("dbrow.collection_log_category_colossal_wyrm_agility") {
                ...
                columnRSCM(
                    COMPLETED_VARBIT,
                    "varbit.collection_other_colossal_wyrm_agility_completed",
                )
            }
