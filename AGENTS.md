...
deviations), `construction.md` (player-owned house: cache tables, region assembly, hotspot
discovery), `construction-verification.md` (manual in-client checklist for the house),
